                                 ...
                                 const MozillaNav = createStackNavigator({
                                  Mozilla:{
                                   ...
                                   defaultNavigationOptions:(props)=> {
                                     ...
                                     headerLeft: <Ionicons name="md-menu" size={32} style={{padding:5,marginLeft:5}} color="white" onPress={()=>props.navigation.toggleDrawer()}/>
                                     ,
                                     headerRight: <Ionicons name="md-qr-scanner" size={32} style={{padding:5,marginRight:15}} color="white" onPress={()=>props.navigation.navigate('Mozilla')}/>,}},});
const DrawerNavigator = createDrawerNavigator(
  {
    ...
    Contact:{screen:ContactNav,
      ...
      }, Mozilla:{screen:MozillaNav,
        navigationOptions: {
          title: 'Mozilla',
          drawerLabel: 'Mozilla',
          drawerIcon: <FontAwesome name="firefox" size={20} color="white" />
        }}
  },
