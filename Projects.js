...
<Card
style={{margin:10,borderRadius:10,borderColor:'white',borderWidth:5,height:527,backgroundColor:'rgba(0,0,0,0.6)'}}>
...
:"black",borderWidth:3,padding:5,alignSelf:'center',marginBottom:-245} 
}>GET THE CODE</Button>
</Card.Actions>
...
const Screen2 = props => {
  return (
    <View style={styles.scrollPage}>
      <Animated.View style={[ transitionAnimation(props.index)]}>
      <Card
style={{margin:10,borderRadius:10,borderColor:'white',borderWidth:5,backgroundColor:'rgba(0,0,0,0.6)',height:527}}>
  ...
  <Text style={{color:'white',textAlign:'justify',fontSize:15,fontWeight:'bold'}}>A simple python program to download Youtube Playlist at once.Project is a simple combination of WebScrapping and Youtube-Downloading</Text>
...
labelStyle={{color:"white",letterSpacing:3}}
style ={{margin:5, height:50,padding:8,width:300,borderRadius:30,marginTop:5,borderColor
:"black",borderWidth:3,padding:5,alignSelf:'center',marginBottom:-310} 
}>GET THE CODE</Button>
  </Card.Actions>
...
style={{margin:10,borderRadius:10,borderColor:'white',borderWidth:5,backgroundColor:'rgba(0,0,0,0.6)',height:527}}>
  ...
  <Text style={{color:'white',textAlign:'justify',fontSize:15,fontWeight:'bold'}}>Living requires water. This project proposes an intelligent Irrigation system which describes how irrigation can be handled smartly using IOT. The objective of this system is to detect the moisture content of the soil and depending on it sprinkle water .This entire information will be sent to the user’s mobile phone.</Text>
...
:"black",borderWidth:3,padding:5,alignSelf:'center',marginTop:5,marginBottom:-190} 
}>GET THE CODE</Button>
  </Card.Actions>
...
style={{margin:10,borderRadius:10,borderColor:'white',borderWidth:5,backgroundColor:'rgba(0,0,0,0.6)',height:527}}>
  ...
  <Card.Content>
    ...
    <Title style={{color:'white',alignSelf:'center',fontSize:25,marginTop:5,letterSpacing:2,fontWeight:'bold',shadowColor:'black',textShadowRadius:13,textShadowOffset:{width:-1,height:1},textAlign:'center'}}>NEURON MODEL FOR BREAST CANCER CLASSIFICATION(MALIGN/BENIGN)</Title>
...
labelStyle={{color:"white",letterSpacing:3}}
style ={{margin:5, height:50,padding:8,width:300,borderRadius:30,borderColor
:"black",borderWidth:3,padding:5,alignSelf:'center',marginTop:5,marginBottom:-78} 
}>GET THE CODE</Button>
  </Card.Actions>
...
<Card.Content>
<Title style={{color:'white',alignSelf:'center',fontSize:30,marginTop:5,letterSpacing:2,fontWeight:'bold',shadowColor:'black',textShadowRadius:13,textShadowOffset:{width:-1,height:1}}}>CIFAR 10 IMAGE CLASSIFICATION USING CNN</Title>
<View style={{borderWidth:1,borderColor:'white'}}/>      
<Text style={{color:'white',textAlign:'justify',fontSize:15,fontWeight:'bold'}}>A multi class-classification using PyTorch and GPU Cuda support, and using CNN for this purpose.This is a part of CNN module of guvi.in, and the code is the same as used in their courses.
A CNN model using CNN built from scratch, as well as using PyTorch's sequential and inbuilt modules, to build a image classifier on CIFAR 10 dataset. </Text>
</Card.Content>
<Card.Actions>
<Button
onPress={()=>Linking.openURL('https://spectrumcet.com/third_project.html')}
...
labelStyle={{color:"white",letterSpacing:3}}
style ={{margin:5, height:50,padding:8,width:300,borderRadius:30,borderColor
:"black",borderWidth:3,padding:5,alignSelf:'center',marginTop:5,marginBottom:-130} 
}>GET THE CODE</Button>
</Card.Actions>
